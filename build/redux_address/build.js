...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Address = __webpack_require__(132);
	...
	var buttonsInstance = React.createElement(
	  ...
	  React.createElement(_Address2.default, null)
	);
...
/***/ function(module, exports) {
	...
	exports.provinceChange = provinceChange;
	exports.cityChange = cityChange;
	var PROVINCE_CHANGE = exports.PROVINCE_CHANGE = 'PROVINCE_CHANGE';
	var CITY_CHANGE = exports.CITY_CHANGE = 'CITY_CHANGE';

	function provinceChange(addr) {
	    return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Address = React.createClass({
	  ...
	  render: function render() {
	    ...
	    */
	    ...
	    var _props = this.props;
	    var provinceChange = _props.provinceChange;
	    var cityChange = _props.cityChange;
	    var addressInfo = _props.addressInfo;
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        addressInfo.get('provinceList').map(function (addr) {
	          return React.createElement(
	            "option",
	            { key: addr.get('areaId'), value: addr.get('areaId') },
	            addr.get('name')
	          );
	        })
	      ),
	...
	*/
	...
	var connectedComp = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Address);
	exports.default = connectedComp;
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var AddressReducer = function AddressReducer(state, action) {
	    if (!state) {
	        state = initState;
	    }
	    ...
	    switch (action.type) {
	        case Actions.PROVINCE_CHANGE:
	            ...
	            newState = newState.set('townList', _immutable2.default.fromJS([{ "areaId": -1, "name": "-请选择-" }]));
	            newState = newState.set('cityList', _immutable2.default.fromJS([{ "areaId": -1, "name": "-请选择-" }, { "areaId": action.addrId * 10 + 1, "name": "成都市" }, { "areaId": action.addrId * 10 + 2, "name": "资阳市" }, { "areaId": action.addrId * 10 + 3, "name": "广元市" }]));
	            return newState;
	        case Actions.CITY_CHANGE:
	            newState = newState.set('cityId', action.addrId);
	            newState = newState.set('townId', -1);
	            newState = newState.set('townList', _immutable2.default.fromJS([{ "areaId": -1, "name": "-请选择-" }, { "areaId": action.addrId * 10 + 1, "name": "武侯区" }, { "areaId": action.addrId * 10 + 2, "name": "锦江区" }, { "areaId": action.addrId * 10 + 3, "name": "高新区" }]));
	            return newState;
	        default:
	            return state;
	    }
